<template>
	...
	<h2 class="margin-top-x margin-bottom-x grey-text lightest uppercase"> Customer API's</h2>
	</div>
	...
	export default {
		...
		methods: {
			...
			fetchAPIList: function() {
				this.$root.$http.get('api/list/category/customer').then(function (response) {
